...
function(req, feat_1_int, feat_2_int = NULL, feat_1_char, feat_2_char = NULL) {
  ...
  if(input_df$feat_1_char == 'Green') model_rds_path <-  "green_model.rds"
  if(input_df$feat_1_char == 'Red') model_rds_path <-  "red_model.rds"
  if(input_df$feat_1_char == 'Blue') model_rds_path <-  "blue_model.rds"
